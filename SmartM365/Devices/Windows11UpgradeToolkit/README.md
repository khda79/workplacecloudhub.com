...
- `Start-Windows11UpgradeRepair-LotLauncher-GUI.cmd` opens a GUI to launch existing operational `Lots\LOT-*` folders or create a new empty LOT.
...
- Use `W11UT_INTUNE_TENANT_ID` when Graph sign-in should target a specific tenant. Use `W11UT_SKIP_INTUNE_INVENTORY_REFRESH=1` to use an existing CSV without refreshing it.
