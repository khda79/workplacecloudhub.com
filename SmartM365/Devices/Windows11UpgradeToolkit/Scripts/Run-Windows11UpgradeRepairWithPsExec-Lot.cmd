...
if not "%W11UT_INTUNE_TENANT_PROFILE%"=="" set "INTUNE_ARGS=%INTUNE_ARGS% -IntuneTenantProfile ""%W11UT_INTUNE_TENANT_PROFILE%"""
...
for /f "usebackq eol=# tokens=1* delims==" %%A in ("%CONFIG_FILE%") do (
    ...
    if /I "%%~A"=="W11UT_INTUNE_TENANT_PROFILE" if not defined W11UT_INTUNE_TENANT_PROFILE set "W11UT_INTUNE_TENANT_PROFILE=%%~B"
