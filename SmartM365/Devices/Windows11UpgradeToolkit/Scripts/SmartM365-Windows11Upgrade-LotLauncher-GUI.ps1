...
function Invoke-AutomaticLotCreateWithProgress {
    ...
    $operation = {
        ...
        & $progressCallback 'LOT creation complete.' ("Created {0} with {1} device(s). The LOT will not be launched." -f $lot.Name,$lot.ComputerCount)
        [pscustomobject]@{
            Result = $created
            Lot = $lot
        }
    ...
    if ($state.ErrorRecord) { throw $state.ErrorRecord }
    if ($null -eq $state.Result) { throw 'Automatic LOT creation did not complete.' }
    # Update the GUI script scope after the isolated progress closure has returned.
    $script:SelectedLot = $state.Result.Lot
    Refresh-LotList
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDwZxE8Y2Wnlg9H
# Ivy/W/F6A+NQK4daQ5GjOQSB8kIHPqCCF/swggS9MIIDJaADAgECAhAebu87xzjh
...
# hvcNAQkEMSIEIBKFlmpzM5Bp6lun47PreRaMqWrPk8D9YZopo2VoIHRAMA0GCSqG
# SIb3DQEBAQUABIIBgIGSkqwb3L1SQPZcx1CWT/3zhpALRZ8anI8pqxGQ6p68uRxo
# 7glzHbJaaM24zrfSUVYFLcNJK7I1p39WLoEGbusPyrsZCjD1y2WO2Y1MZbY7PgLD
# Fzols1VVojo/lzds/Jil/yOYGiw7VNACtAHF9C9BBd0p4RawvrEqchyh/rDqXamC
# bhaKg89C/XhAuQBjaifl/IAYgeH7SnOSqhpUBw5Tnoe6nNeyU9VHfK7KjyNtSIZK
# nu3RnMom0MRYVTaJaufMWF/bAEa6+E2emI0fhFtM5RN5KX9P6KVjRtgIHcGcoA1u
# VUXHB8wpJcTophvJUVY34wvkBE81KBfpMbqHJV9XlJ2QnrUyZc5lHLBOKm4awH9O
# w7OOqi9lep7wQk6cEaTAuzalXBs24+dN9Fau1dbfaRrx5DNTnpYSNr9MJfwNajKq
# ejo3erso93h7FHQHEHpHtEUMfjtOLGVVUlQ5J/iW7L/grGFpTjh5214biUJoJdjX
# D919WiSsj4CWw9ZKgKGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkx
# CzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4
# RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYg
# MjAyNSBDQTECEAhP3DNPfkVO28MPj/mSGDUwDQYJYIZIAWUDBAIBBQCgaTAYBgkq
# hkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjA5MDcxMTUz
# MTVaMC8GCSqGSIb3DQEJBDEiBCCpm4LH2PCL2+QNuBuBIr7QyasdkzEsxK3EjINe
# zrUOaDANBgkqhkiG9w0BAQEFAASCAgCYAaJpC9q0PQk0pbV8YdJnU98y/jKWWfHS
# StOfPdQ5Icwmoc+4+/XYXM/ifpKLoVyyRySEn/+lZ5N4La2cN1vnSHgdpeEdlZFJ
# gzXSoJzq7hZImZ/sVgT6liDe2M8TzNFZ+JjEU3SB8ZsSFhfBTQO2eGV9E0HxtOb3
# vtM1F/D0QA6xAHnXsI38Kxp4vpxAIsfTkZI5vJiZTE2YxqRj2dCoQqdYg/BL171i
# HBPlm/6/ThCDpix6rfpy/u/SZKSnRcbIWxtex/UDxrC36FbBIiW4TzpORFbLdOJV
# qJ4x2XJ+iZagfNuiTaZiWInal3IBpbB2IF2XZvemLop+dz1lcJWQEFR/Ab8+BQYI
# Z2AZzaTsOUmD1+/BQgp6rzNZihYzzgr9CMWtB0IZIr6+aacwMkCFSOtnBx3I3Pco
# f3ilpqJp6nMn6nxQsfGHtrrhNCiduIFLioxhIg0l+TC2FR9p9zpCflxEed5RaTcW
# 8dPxpBWXRU/y3R0bp+pOWaBbAdoTKHiZjUTxXg6QkY7Riw4BIE8VwGK+g+XTcvdn
# aG8+J7zS6y5p+L9UOQCmqIB11+MhKdddDfxGlTKYny0rvOGFlSvbcMdtAz6XTG75
# sv+hAM/UmbZGDj+messDYKhuxHmUg14BqQ210G/+h1MuIBPCN5k2cGXB9wK58M00
# +ol3i1tmeg==
