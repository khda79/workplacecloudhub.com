...
| `Reports.Read.All` | Reads Microsoft 365 usage reports, including active user, mailbox usage, OneDrive usage, SharePoint site usage, Office activations, Teams activity, Teams team activity, email activity, and licensed Microsoft 365 Copilot user usage reports for FinOps and adoption analysis. | `SmartInventory/M365Inventory/Usage/SmartM365-M365UserActivity-Inventory.ps1`; `SmartInventory/M365Inventory/Usage/SmartM365-CopilotUsage-Inventory.ps1`; `SmartInventory/M365Inventory/SharePoint/SmartM365-SPO-Inventory.ps1`; `SmartInventory/M365Inventory/Teams/SmartM365-Teams-Inventory.ps1`. |
