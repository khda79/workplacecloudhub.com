...
function Add-SmartM365MailBranding {
    ...
    if ($branding.Enabled) {
        ...
        if (-not [string]::IsNullOrWhiteSpace($logoDataUri)) {
            ...
            $logoHtml = "<td width=`"112`" style=`"width:112px;padding-right:12px;vertical-align:middle;`"><img src=`"$safeLogoDataUri`" alt=`"$clientName`" width=`"92`" style=`"display:block;width:92px;max-width:92px;height:auto;border:0;outline:none;text-decoration:none;`" /></td>"
        }
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBQoNFeW+gww1Uj
# GR3c+CQqkpCA3XZ5hxbQ7c+L9gR1tKCCBBQwggQQMIICeKADAgECAhBwIfLVIgJW
...
# BDEiBCCejGAooe4kuZjXnVO5qMaDIM/OTSbHia5NibTcoqf0gjANBgkqhkiG9w0B
# AQEFAASCAYAoOxCybFWDimKwY/R1SUOzhDvxxSUphltGeTwEPlib7hVLA+7Rxuyz
# dqZN1Ce2RMERVQ+xPMQhEUYghT/n0NO0tYPvk8P6fNXigE51vOSCqQj0rgAWom75
# lVb4GKJukSWyiT9kX+4s3o4bG8ms0q7wfjn+XncSnrma+StOnIQlWhcgYm+ut4yP
# hVN4sQeZCpEhNYOmPfiX5jDHAW0UrK0EkZtJk66nBd87p8pzBeW0es/hoaoIAX8D
# AoluN6K91dAq62BT2U3GEIKhkLdXt3hdNcPTF/h82FMxlDWHw0aCo+CDbRmB68z3
# Cc3XvN4P3In7Q75dvwpE0wZtjFd269bKprrwYb75yvSXYn0B6i4vPW1ZjGzedqpi
# x8pHQDReC5g84UFWWcR3mKz4ZmQAj2UN6YQ2mi9BNqp+0we4CzKhXkoJRxnYpF6k
# l3dHanGxfjWYKPkScaLNNI/Y07BJ2c7/0rfmU2TVPEIcS7oUrC4AJ+t8bv/6dA+y
# 5oF1jxComZU=
