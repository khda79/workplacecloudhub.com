...
try {
    ...
    Import-TestFunctions (Join-Path $project 'SmartM365-SharePointMigration-GUI.ps1') @('Invoke-MigrationAction')
    ...
    # Mock the process boundary, preserving the real GUI action/argument logic.
    function Get-AuthMode { 'Interactive' }
    function Start-Process { param($FilePath, $ArgumentList, $WorkingDirectory) $script:LaunchArguments = $ArgumentList }
    $script:ScriptRoot = $project
    $script:CurrentMigration = [pscustomobject]@{ Name = 'Folder Example'; Config = @{ Name = 'Different report label' } }
    Invoke-MigrationAction 'ScanSourceFiles'
    $index = [array]::IndexOf($script:LaunchArguments, '-MigrationName')
    Assert-Test ($script:LaunchArguments[$index + 1] -eq '"Folder Example"') 'GUI must launch the discovered directory, not the report label.'
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDYaQENecKbBA5Q
# Gqm+p9fkSwTfQO5P26tcb/gahozAXqCCF/swggS9MIIDJaADAgECAhAebu87xzjh
...
# hvcNAQkEMSIEIDJgK2/Dc43KiRxZRwBjnhmCf/shx5aOoOwNS3jEgEWzMA0GCSqG
# SIb3DQEBAQUABIIBgBnVLD/LsUHzpbMpAU7qNEajzAfGmB4yaAbUcSllwWSUTvkl
# y5WwzXNNPr47D+89C89ETEClJJzlixMBouv3ppC85diZruBoxHwnmPbcIoXGfxNA
# XBxfjWFiD2WPcskOjrMJEPluADA3N0Hgfxhfhydo9EsdIh0F8yYOV3lgRJFkaSVr
# YhB5Ym/C76eug5myLb5cosfAppAHixrqHvIoa3r5DJ+GM5Tb9LM6XYkl7Si2cMBO
# 01PzGfNDVtnf059tHU8KVGNk/DMFdv0BR4f5uzdxWTcwgXXx8M0kipBNOOgQT3t+
# Uop2dI/QaOpFQTzh08poueq8+9ZypctBcDiG1+huj6UmY+kMkUSoQtNf2nhed+0G
# F9L8n6q8Kn4YY0vnuiqMx9myGBn8J5eQ+TcHCFa8/+3hnqfPeWKL9SB1ABou4w6U
# JRx+t8oWR5kaCvf/6WL4IA+VR2aC+W8Lr8jEeh83DTBRFvuGnw4FENbpVO+nQQiJ
# r4/7kHxOpEyGKHogpqGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkx
# CzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4
# RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYg
# MjAyNSBDQTECEAhP3DNPfkVO28MPj/mSGDUwDQYJYIZIAWUDBAIBBQCgaTAYBgkq
# hkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjA5MDgxNjA2
# MTVaMC8GCSqGSIb3DQEJBDEiBCB0W+Z0yNOfTMBDC/uvuWUrgn8NfCHJ/e6Jaf8a
# PqDm3DANBgkqhkiG9w0BAQEFAASCAgCaml4sDDKS4K3ItJnXBQbxyjN9xswNijlq
# XgsX/dZ7dUabd35d4BobdjbIzSpKiPAbSnQu37Rlwa/2BflrMUGEBiM5fZmfL2im
# 6aH8g9ktDVmvb31g7aLrt8unCuxBfhikhm5ulpEnoOeh4LR2OhV2iDNaFf96P0EE
# BVPzYaKfz8SKMW6VW2yo3WYj/RZmcoP4wpXfQYgqiv2B4dMnsx4ytCsbaeGvtOq8
# OfvklkGHSLvZJ4AZuQE36aJY43ulzZU+MW39WbimcLiC+zvu5mYFQ8pedfULJaIc
# 44H5tWGbBLxmzEpwVRezFdHIwWtxiKngu+zJnhbOlDvBIYL62+RukdMCH3qSCmM8
# ZYFbixknsSaGagzxaBgq9YZCiBT3Miy/XHdbEdprIZ/29NOkVQ1GbRxM9SPExcA9
# V7Np8vcs6yOx6BJwkX82mqVV7mxrRN+XeB/VNzBmuZv5+uVgOV+RiHsl3A6b80u1
# 2nkB0q5N9tvJzlU/E/gU/pUKk4MNaCTO3r+leKRw+szcXmfbsw3J3DGQ0Ptd93dg
# cRJ+d5loT5HQgzg4sMyRmfXE+Xxcj2ITPxcWnW8po0fPv8tf5fyscqUcbkFJy+LE
# f9DVj5jBic9eTJT0ZfWTE1XzRsZSy+wacLwd4m1zYmu5eXdwj/ImBFHBkgHF0PQu
# eaudnKJPuQ==
