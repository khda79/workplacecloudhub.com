...
try{
    ...
    $rows=ConvertTo-AuthenticationRegistrationRows $raw $script:Runtime.RunId $script:Runtime.CollectedAtUtc
    $columns=@('RunId','CollectedAtUtc','CollectionStatus','IsPartialInventory','SourceScriptVersion','UserId','UserPrincipalName','UserDisplayName','UserType','IsAdmin','IsMfaCapable','IsMfaRegistered','IsPasswordlessCapable','IsSsprCapable','IsSsprEnabled','IsSsprRegistered','MethodsRegistered','LastUpdatedDateTime')
    Export-SmartM365EvidenceDataset $script:Runtime 'M365_Entra_AuthenticationMethodsRegistration' $rows $columns|Out-Null
}catch{$script:CompletionStatus='Failed';$script:CompletionError=$_;throw}finally{try{Disconnect-MgGraph -ErrorAction SilentlyContinue|Out-Null}catch{};if($script:Runtime){Complete-SmartM365EvidenceRuntime -Status $script:CompletionStatus -ErrorRecord $script:CompletionError -FailureStage 'AuthenticationMethodsInventory'}}

# SIG # Begin signature block
# MIIeYwYJKoZIhvcNAQcCoIIeVDCCHlACAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCzY+mIerXve9Fz
# s8wLXnWqeqUONbbkXhEogZobjVRJuaCCF/swggS9MIIDJaADAgECAhAebu87xzjh
...
# hvcNAQkEMSIEIKHY+Cev445vdWKmTOTFxpuW92JhqrCmFm1sUmQWaadZMA0GCSqG
# SIb3DQEBAQUABIIBgJQg9bPe1eQ61b8PvEFuonnuOFWYAxj0lw2BlXtc2tuEGTqC
# wJqeunBjNK4rBv5XF53vALeQ6L+EzJ0DQ1vCvMyb1MB6CHB5I4XWhboIPX23jOrw
# yjDZnboddouJ/DlK8NVFQUUom+VZu+VAqyTDGA+QM/9QNy78p/w4MjDgLAKQy3By
# RG7NU4OcCuPjLyQYRgdETzC8YWbjzHIiQNnIdcZerRH2Vz6np7lisba0RSc1haUh
# 56R2R+l8kliFMsRqFfeQTu0zkYp3H/5c3VJIj13i3OH5Oyfnnt6DDUZe8eDr/Kgx
# 61YzXcZ73XKWwVPl3shSN8O1tA7anLee1SX/lzPkpegzU3pXmEmkTuCDtI+6JRPI
# 7/Ob/Pg+fc1YmFRMrHf0nGxqM8WmuTgxUO/JDUtDS30/FSUQQZBUic7ALQSjGBfP
# cM+95nkUYQf3HnhNzl7q3+J/2xkL5a2jwT20HE7pJJn71I/sa23+RWm4Y1f737uR
# j1y+mRskBopXhsZpNaGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkx
# CzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4
# RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYg
# MjAyNSBDQTECEAhP3DNPfkVO28MPj/mSGDUwDQYJYIZIAWUDBAIBBQCgaTAYBgkq
# hkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjA5MTcxMjQz
# MDJaMC8GCSqGSIb3DQEJBDEiBCDDqglXj5IRNppUc+XBvo6Y73ybENslMJa3SWyx
# UkU71zANBgkqhkiG9w0BAQEFAASCAgAHOYC2lWqnfYozt2jTPlLgF8dmkqiqD8FZ
# i1WzVw/3lztI4tOlOwjpnwp8xF+37EtVQfvrnbTVApBBVCwTr+TO5o2tmflhAgFi
# jrk6Dmp5/wOL9JzEl12hEFeESqg6cVDHR7QoiYeY/Vkw3eaiBzMHmaSPhX0n2JbU
# AemnJxuzIRzW/wFH6uAO3tMem3MXnvh8ocT+qwHwfBDW4XxfMSlISIcxuyPmy+bq
# N7LC6O22ZZnoYEGD+C+fbGDqvRwgltG22kl7MbZrkLZBUy1XrRdCrlami/tkaqBp
# GuAH+ztkFXJlscmTOLGqm0DMtoWgmOqGioqIzaPzPm2JFl0OTUAwNzFtuvaKBJnd
# AYjXcm7MOw/MVtTHy6UruUJtTocXctnem5IrIVN/M6q7yaF1axxM/XuYjlLqDFHp
# JWgbSVwWtrlLKuCwfHUAmBbiN4mfR/hm00L78AP/Ya5d8uRfrnXIveDKy1kbItQE
# PU00Yjv9KcUNVvfWlZSNtqwzhliHNqZUO9qhX+3s8HeIH87pZhAjvkGzl8B5jTzB
# 4M+u71eCo3ZoZ7qrc4vrjK/bKHQZHTPYbPLQ1sf9AlEraLhv2kkMG8Qh/AktagN1
# hspxIWBt8HmsYLJ9FdPKCRfOC8e7wxkxgA5xQBuW3SXakdkdq63kM++KMwBVJQ0c
# TpByStyS5g==
