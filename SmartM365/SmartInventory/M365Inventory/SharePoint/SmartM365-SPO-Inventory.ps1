...
function New-SpoHtmlSummary {
    ...
    return "<!doctype html><html><head><meta charset='utf-8'><title>$(ConvertTo-SpoHtml $Title)</title></head><body style='margin:0;padding:0;background:#f4f7fb;font-family:Segoe UI,Arial,sans-serif;color:#111827;'><table role='presentation' width='100%' cellpadding='0' cellspacing='0' style='background:#f4f7fb;padding:18px;'><tr><td align='center'><table role='presentation' width='760' cellpadding='0' cellspacing='0' style='background:#fff;border:1px solid #d9e2ec;border-collapse:collapse;'><tr><td style='background:#0f172a;color:#fff;padding:22px 24px;'><div style='font-size:12px;text-transform:uppercase;color:#93c5fd;font-weight:700;'>SmartM365 SharePoint Online Inventory</div><div style='font-size:22px;font-weight:700;margin-top:6px;'>$(ConvertTo-SpoHtml $Title)</div><div style='font-size:12px;margin-top:10px;color:#cbd5e1;'>Machine: $(ConvertTo-SpoHtml $env:COMPUTERNAME) | Generated: $(ConvertTo-SpoHtml ((Get-Date).ToString('yyyy-MM-dd HH:mm:ss zzz')))</div></td></tr><tr><td style='padding:18px 24px;'><span style='display:inline-block;border-radius:999px;background:$statusBg;color:$statusColor;border:1px solid $statusColor;padding:4px 12px;font-size:12px;font-weight:700;'>$WorstStatus</span></td></tr><tr><td style='padding:0 24px 16px;'><h2 style='font-size:15px;margin:0 0 8px;'>Alerts</h2><table width='100%' style='border-collapse:collapse;border:1px solid #d9e2ec;font-size:12px;'><tr><th align='left' style='padding:8px;background:#f8fafc;'>Severity</th><th align='left' style='padding:8px;background:#f8fafc;'>Category</th><th align='left' style='padding:8px;background:#f8fafc;'>Site</th><th align='left' style='padding:8px;background:#f8fafc;'>Value</th><th align='left' style='padding:8px;background:#f8fafc;'>Details</th></tr>$($alertRows -join '')</table></td></tr><tr><td style='padding:0 24px 16px;'><h2 style='font-size:15px;margin:0 0 8px;'>Summary</h2><table width='100%' style='border-collapse:collapse;border:1px solid #d9e2ec;font-size:12px;'>$($summaryRows -join '')</table></td></tr><tr><td style='padding:0 24px 18px;'><h2 style='font-size:15px;margin:0 0 8px;'>Top 20 largest sites</h2><table width='100%' style='border-collapse:collapse;border:1px solid #d9e2ec;font-size:12px;'><tr><th align='left' style='padding:8px;background:#f8fafc;'>Site URL</th><th align='right' style='padding:8px;background:#f8fafc;'>Used GB</th><th align='right' style='padding:8px;background:#f8fafc;'>Quota %</th></tr>$($topRows -join '')</table>$technicalHtml</td></tr><tr><td style='padding:12px 24px;color:#64748b;font-size:11px;border-top:1px solid #e5edf5;'>This automated message was generated by SmartM365.</td></tr></table></td></tr></table></body></html>"
}
...
try {
    ...
    if ($mailShouldSend) {
        ...
        Send-SmartM365Mail -Subject $subject -BodyHtml $bodyHtml -Attachments @($generatedCsvPaths | Select-Object -First 4)
