...
.REQUIREMENTS
    ...
    Minimum permissions: Exchange on-premises recipient read access for mailbox/remote mailbox data; AD read access for recipient and optional AD permission data.
...
$LimitResultSize = if ($MaxItems -gt 0) { $MaxItems } else { $null }
if ($LimitResultSize) {
...
try { # Main try block for script execution and interruption handling
    ...
    function MailboxesProcessing2 {
        ...
        if ($MaxItems -gt 0) {
            $preMaxItemsMailboxCount = @($AllMailbox).Count
            $AllMailbox = @($AllMailbox | Sort-Object PrimarySmtpAddress,Name | Select-Object -First $MaxItems)
            Write-LogMailboxesProcessing "MaxItems enabled: restricted local mailboxes from $preMaxItemsMailboxCount to $($AllMailbox.Count)."
            WriteLog -Message ("MaxItems enabled: restricted local mailboxes from {0} to {1}." -f $preMaxItemsMailboxCount, $AllMailbox.Count) -Level 'WARNING'
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBatRvOoXEVcJJO
# SMOmZ9MbPlyu/BQ0gSDm5KDMmCmYd6CCF/swggS9MIIDJaADAgECAhAebu87xzjh
...
# hvcNAQkEMSIEIGAM8uw/fZJ6pKZhaQHnLPEw2JaZqrrKsV2qh0um8oyRMA0GCSqG
# SIb3DQEBAQUABIIBgGybzWJnPv9GiCdtT+KlObtbTCBupgay1SyWnH7ckYTEg9Ki
# ZoH8GBk+mssWhvr1c9CRfyLnCxWTv3d8X8/vgwDNvveFELt3ez0LIkU4X5EDLQ0v
# QdodRW+we2P36MLjSIv5S5zgIyaJHC6/XfFBzQUkiFgblf9LcnDFavyHNx5QHHgc
# I8tuprQ1rEfhHg6GBcfzJKaBBIjLvKEWZZszkXiHDJgOkNAdtn3P8G0bc/xPbAO+
# XxEd23jARzMAykhY6L4W3ZcBPG4rgenpzett0M5xcNB+2m+CIQ7mxpyc5woQp9oI
# iCnBcYmbEOxb5G3upO2IWqXoysuyjh2GVWhRMzGsMpVDRviX9lNVbpye18bYlzru
# JqKh6IE9Yu5BHq3RbOn39rffCPQlvPnOroxSNh/bUn5lSdpODj4eyDp/LELu3QJX
# AiNj7B8bbp/ufCBFuyn/vTQPByiro7kXskCN/QNVKYrZLNl7e6jpmDogTnEiNc+2
# BgeEf7beIOkjtjelO6GCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkx
# CzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4
# RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYg
# MjAyNSBDQTECEAqA7xhLjfEFgtHEdqeVdGgwDQYJYIZIAWUDBAIBBQCgaTAYBgkq
# hkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjA3MTMwODUw
# MjZaMC8GCSqGSIb3DQEJBDEiBCBj3/6LROpvDKfwSwokE0EGj8roUD0hnhypa5ki
# uyKaJzANBgkqhkiG9w0BAQEFAASCAgAnKJA3r4IVX0Wb9M2qmStigw7T1nlvrN1x
# gXCAHwY5MKGNz7KRZD+MlrWo6yOwZlriwYrEaXJAxiiOxI8GRzHvnki+tip/D0wH
# L0SYztTGnENMe0IHBjlE2to0zaxcg+11Q9hVVgoKyHewmRKJVI/Eq7g2C3bQ/806
# sKOeyAFSz9kAKaxtNXW+QaEdKDbhV6OnTiyuWL6MtsUNHD9dxRiynH2kthrAWs0D
# O6WGcUpagnKfVGIy7dQKPQZz+w7S+BAgNbXIzQRFuMURtEyLnej55JRnmzQdZ/rD
# 4JwvuKZQhLYJYPk72/+Ugbs5WO6n+fj4fjSwWqDTB17tC/7ogCJNpFpcacQrbGS4
# yPY4gbkgnwsUdQitHVScu0MoMFOYWt1IG5iVNtVnO7ze/1lFCnjAsncH+bqMmPTj
# lEfAodsOTaAn8aqnDv7yEf+8M0TtP4ctIo4YPsdSVRJtKtiyxNdOk570uXjZU/ov
# 3RStRDeuU6VtFMNY7qUzdH5XxyidSTsp09Je70bu3mlHah338VQ5lyKWPlx3j5BH
# gFoMZkJH4G6yvZ/ISNZk137jwynWeITHbnOv95OIpPSW1Xm7WO55tNhP1DzbMWuM
# 0NItulHLfSQf2ogTE0PmMIynDD20opuALgXndSKyOtVBy9UotYfZQbiTqMXvnxwP
# uezjN6Ap4w==
