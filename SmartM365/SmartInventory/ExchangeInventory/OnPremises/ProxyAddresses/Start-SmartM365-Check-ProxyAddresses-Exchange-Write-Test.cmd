...
"%POWERSHELL5%" -NoProfile -ExecutionPolicy Bypass -File "%LOCAL_SCRIPT_DIR%\SmartM365-Check-ProxyAddresses-Exchange.ps1" -Tenant test -AddMissingAddress -SkipAllowListCsv
