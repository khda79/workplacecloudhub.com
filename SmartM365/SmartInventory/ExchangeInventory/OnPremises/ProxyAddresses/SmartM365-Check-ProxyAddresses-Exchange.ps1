...
# === End Email notification ===
	...
	Remove-SmartM365TimestampedFilesOlderThan -FolderPath $OutputPath -FilePattern 'Exchange_OnPrem_ProxyAddresses_*.xlsx' -RetentionDays 7 -LogFile $global:logTextFile
