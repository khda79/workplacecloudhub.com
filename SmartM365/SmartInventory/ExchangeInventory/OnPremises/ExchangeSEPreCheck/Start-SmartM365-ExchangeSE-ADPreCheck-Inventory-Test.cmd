...
set "CACHE_BASE="
call :TryCacheBase "%ProgramData%\SmartM365\LauncherCache\ExchangeSEPreCheck"
if not defined CACHE_BASE call :TryCacheBase "%SystemRoot%\Temp\SmartM365LauncherCache\ExchangeSEPreCheck"
if not defined CACHE_BASE call :TryCacheBase "C:\Temp\SmartM365LauncherCache\ExchangeSEPreCheck"
if not defined CACHE_BASE call :TryCacheBase "%TEMP%\SmartM365LauncherCache\ExchangeSEPreCheck"
if not defined CACHE_BASE (
    echo Failed to create a writable local cache base folder.
    echo Tried:
    echo   %ProgramData%\SmartM365\LauncherCache\ExchangeSEPreCheck
    echo   %SystemRoot%\Temp\SmartM365LauncherCache\ExchangeSEPreCheck
    echo   C:\Temp\SmartM365LauncherCache\ExchangeSEPreCheck
    echo   %TEMP%\SmartM365LauncherCache\ExchangeSEPreCheck
    pause
    popd
    exit /b 1
)
...
set "LOCAL_SCRIPT_DIR=%LOCAL_SMARTM365_ROOT%\SmartInventory\ExchangeInventory\OnPremises\ExchangeSEPreCheck"
...
"%POWERSHELL5%" -NoProfile -ExecutionPolicy Bypass -File "%LOCAL_SCRIPT_DIR%\SmartM365-ExchangeSE-ADPreCheck-Inventory.ps1" -Tenant test %*
