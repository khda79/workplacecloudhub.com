...
pushd "%~dp0..\..\ActiveDirectoryInventory\" >nul 2>&1
if errorlevel 1 (
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-ActiveDirectory-HealthCheck.ps1" -Tenant "%SMARTM365_LAUNCHER_TENANT%"
