...
set "CACHE_BASE="
call :TryCacheBase "%ProgramData%\SmartM365\LauncherCache\ExchangeCalendarPermissions"
if not defined CACHE_BASE call :TryCacheBase "%SystemRoot%\Temp\SmartM365LauncherCache\ExchangeCalendarPermissions"
if not defined CACHE_BASE call :TryCacheBase "C:\Temp\SmartM365LauncherCache\ExchangeCalendarPermissions"
if not defined CACHE_BASE call :TryCacheBase "%TEMP%\SmartM365LauncherCache\ExchangeCalendarPermissions"
...
set "LOCAL_SCRIPT_DIR=%LOCAL_SMARTM365_ROOT%\SmartInventory\ExchangeInventory\OnPremises\CalendarPermissions"
...
if %ROBOCOPY_EXIT% GEQ 8 goto :CacheFailed
...
:CacheFailed
echo Failed to prepare the local SmartM365 runtime cache.
