...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\IntuneInventory\WindowsUpdate\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-Intune-Windows11-Readiness-Issues-Inventory.ps1" -Tenant prod %*
