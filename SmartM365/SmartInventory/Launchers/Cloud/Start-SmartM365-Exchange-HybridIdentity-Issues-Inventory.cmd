...
set "UNC_WORK_DIR=%~dp0..\..\ExchangeInventory\Migration\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-Exchange-HybridIdentity-Issues-Inventory.ps1" -Tenant prod %*
