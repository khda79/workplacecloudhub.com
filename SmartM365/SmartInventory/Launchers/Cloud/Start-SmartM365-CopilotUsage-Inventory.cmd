...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\Usage\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-CopilotUsage-Inventory.ps1" -Tenant prod -Period D180 -ReportVersion v2 -Connect %*
