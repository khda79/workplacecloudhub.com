...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\Security\ConditionalAccess\."
set "SCRIPT_PATH=%UNC_WORK_DIR%\SmartM365-ConditionalAccess-Inventory.ps1"
set "PWSH="
...
if not "%EXIT_CODE%"=="0" call :Log "Conditional Access inventory failed with exit code %EXIT_CODE%."
exit /b %EXIT_CODE%
