...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\IntuneInventory\EndpointAnalytics\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-EndpointAnalytics-Inventory.ps1" -Tenant prod -Reports All -Connect -IncludeStartupProcesses %*
