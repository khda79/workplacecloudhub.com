...
set "UNC_WORK_DIR=%~dp0..\..\ExchangeInventory\AcceptedDomains\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-EXO-AcceptedDomains-Inventory.ps1" -Tenant prod -Connect
