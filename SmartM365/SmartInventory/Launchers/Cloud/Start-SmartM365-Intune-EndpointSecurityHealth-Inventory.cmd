...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\IntuneInventory\Security\."
set "SCRIPT_PATH=%UNC_WORK_DIR%\SmartM365-Intune-EndpointSecurityHealth-Inventory.ps1"
set "PWSH="
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_PATH%" -Tenant prod -EnableConfiguredExternalActions -ExportTimeoutSeconds 1200 %*
set "EXIT_CODE=%ERRORLEVEL%"
if not "%EXIT_CODE%"=="0" call :Log "Endpoint security health inventory failed with exit code %EXIT_CODE%."
exit /b %EXIT_CODE%
