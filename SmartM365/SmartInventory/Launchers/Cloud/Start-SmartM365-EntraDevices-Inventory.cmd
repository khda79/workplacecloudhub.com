...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\Devices\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-EntraDevices-Inventory.ps1" -Tenant prod -Connect
