...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\SyncHealth\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-AzureADConnect-SyncHealth-Inventory.ps1" -Tenant prod
