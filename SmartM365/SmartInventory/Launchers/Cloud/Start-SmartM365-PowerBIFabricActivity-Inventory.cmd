...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\PowerBI\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-PowerBIFabricActivity-Inventory.ps1" -Tenant prod -LookbackDays 28 %*
