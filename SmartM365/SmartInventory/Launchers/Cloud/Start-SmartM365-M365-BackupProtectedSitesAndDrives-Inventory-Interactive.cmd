...
set "SCRIPT_PATH=%UNC_WORK_DIR%\SmartM365-M365-BackupProtectedSitesAndDrives-Inventory.ps1"
set "PWSH="
...
call :Log "Starting Microsoft 365 Backup inventory with interactive authentication."
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_PATH%" -Tenant prod -InteractiveAuth -EnableConfiguredExternalActions %*
set "EXIT_CODE=%ERRORLEVEL%"
if not "%EXIT_CODE%"=="0" call :Log "Microsoft 365 Backup sites and drives inventory failed with exit code %EXIT_CODE%."
exit /b %EXIT_CODE%
