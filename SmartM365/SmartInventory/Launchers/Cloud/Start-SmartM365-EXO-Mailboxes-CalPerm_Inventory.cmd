...
set "UNC_WORK_DIR=%~dp0..\..\ExchangeInventory\CalendarPermissions\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-EXO-Mailboxes-CalPerm_Inventory.ps1" -Tenant prod -Connect %*
