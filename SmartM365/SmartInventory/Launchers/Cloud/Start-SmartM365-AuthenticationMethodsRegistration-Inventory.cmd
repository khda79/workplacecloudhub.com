...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\Security\AuthenticationMethods\."
set "SCRIPT_PATH=%UNC_WORK_DIR%\SmartM365-AuthenticationMethodsRegistration-Inventory.ps1"
set "PWSH="
...
if not "%EXIT_CODE%"=="0" call :Log "Authentication methods inventory failed with exit code %EXIT_CODE%."
exit /b %EXIT_CODE%
