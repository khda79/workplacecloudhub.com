...
echo Detailed Intune compliance policy-state collection is enabled.
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-Devices-Compliance-Inventory.ps1" -Tenant prod -Connect -CollectPolicyDetails %*
