...
set "UNC_WORK_DIR=%~dp0..\..\M365Inventory\IntuneInventory\Autopilot\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-WindowsAutopilot-Inventory.ps1" -Tenant prod -Connect
