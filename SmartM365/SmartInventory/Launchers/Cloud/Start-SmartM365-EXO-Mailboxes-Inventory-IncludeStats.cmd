...
set "UNC_WORK_DIR=%~dp0..\..\ExchangeInventory\Mailboxes\."
...
"%PWSH%" -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_DIR%SmartM365-EXO-Mailboxes-Inventory.ps1" -Tenant prod -Connect -IncludeStats
