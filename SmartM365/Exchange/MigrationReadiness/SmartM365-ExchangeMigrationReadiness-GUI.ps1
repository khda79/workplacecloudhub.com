    ...
    <Grid Margin="18">
        ...
        <Border Grid.Row="3" Background="{StaticResource PanelBrush}" BorderBrush="{StaticResource BorderBrushSoft}" BorderThickness="1" CornerRadius="8" Padding="10" Margin="0,12,0,0">
            <Grid>
                ...
                <TextBlock x:Name="VersionText" Grid.Column="2" Text="v1.11.14" Foreground="{StaticResource MutedBrush}" VerticalAlignment="Center"/>
            </Grid>
        </Border>
    </Grid>
</Window>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBtpTW6XgYKQRTN
# GoBjfLx4aOZqlKgG4sI2v+Xp1crC0aCCBMEwggS9MIIDJaADAgECAhAebu87xzjh
...
# DjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAlcNGPgRNVUMglhLpEHl6E
# DfxT6KoL7XmmQsbnUJxOJDANBgkqhkiG9w0BAQEFAASCAYCasYEddyF0BqMfTFve
# OfvSemkKuOX7/uyOUu1il1q3wvDNCIFAHaAsKo6vu6XvBL59ushlELIa5fSXew8t
# A0Q5bvD8cuX0HiDOSTTbMBkhw9hSO0EGsBgAEZduZBlOC6XQbylxSfvmI0RZkKdX
# 5ze+sdRZMMv+Ad75J+nDP0YV6Dht//qdfIWNpnPGs6oJZ/EWOMjow3vur3MXXoen
# CC5Ohkr1ZKveIgTyHgrQTP2WnswvMacuA1p/bu6/jzIoAySe2htOSKZUKzmKeFdg
# ufuKhiAlSw6ahKVq2zGzuXFa9GCCXqzIfNR9WbiZYEw46at2k1K5VL0P5xw5rU0H
# U/N+9dXpezjXc8gojH3aqMpsxr0dgTos1feeU2Vb/kJnut88D/f0jhbcF63evjbE
# hPSuYZmnGvrITwr3qqmW2Avs25n27YnG+RbP1zKpFMs1atJ/lpfJJTBK0xEEE5Du
# nGK8mQLtHhvdC8YUxbDtHR7H5YmfpWbwryMC+n+3QPnAooM=
