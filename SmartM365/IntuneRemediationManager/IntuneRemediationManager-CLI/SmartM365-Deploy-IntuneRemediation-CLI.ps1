...
.EXAMPLE
    .\SmartM365-Deploy-IntuneRemediation-CLI.ps1 -Path ..\..\IntuneRemediation\WindowsUpdate\Cache-Health

.EXAMPLE
    .\SmartM365-Deploy-IntuneRemediation-CLI.ps1 -Path ..\..\IntuneRemediation\WindowsUpdate -Recurse -UpdateExisting

.EXAMPLE
    .\SmartM365-Deploy-IntuneRemediation-CLI.ps1 -Path ..\..\IntuneRemediation\WindowsUpdate\Cache-Health -AssignmentGroupId "00000000-0000-0000-0000-000000000000" -RunRemediationScript
