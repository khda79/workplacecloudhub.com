function Initialize-SmartThinClientNativeWindowApi {
    if ('SmartThinClient.NativeWindow' -as [type]) { return }

    Add-Type -TypeDefinition @'
using System;
using System.Runtime.InteropServices;
namespace SmartThinClient {
...
function Set-SmartThinClientWpfWindowVisible {
    [CmdletBinding()]
    param([Parameter(Mandatory = $true)]$Window)

    try {
        Initialize-SmartThinClientNativeWindowApi
        $helper = [System.Windows.Interop.WindowInteropHelper]::new($Window)
        if ($helper.Handle -ne [IntPtr]::Zero) {
            [void][SmartThinClient.NativeWindow]::ShowWindow($helper.Handle, 5)
            [void][SmartThinClient.NativeWindow]::SetForegroundWindow($helper.Handle)
        }
...
function Start-SmartThinClientGuiSplash {
    [CmdletBinding()]
    param(
        [ValidateSet('Wpf')]
        [string]$Framework = 'Wpf',

        [string]$ProductName = 'SmartThinClient',
    ...
    if (-not $workplaceLogoPath) {
        $SmartThinClientRoot = Split-Path -Parent (Split-Path -Parent $PSScriptRoot)
        foreach ($relativePath in @(
            ...
            $candidate = Join-Path $SmartThinClientRoot $relativePath
            if (Test-Path -LiteralPath $candidate -PathType Leaf) {
                $workplaceLogoPath = $candidate
                break
            }
    ...
    $window.Show()
    Set-SmartThinClientWpfWindowVisible -Window $window
...
function Wait-SmartThinClientGuiSplashMinimum {
    [CmdletBinding()]
...
function Hide-SmartThinClientGuiSplash {
    [CmdletBinding()]
    param([AllowNull()]$Splash)

    if ($null -eq $Splash -or $null -eq $Splash.Window) { return }
    Wait-SmartThinClientGuiSplashMinimum -Splash $Splash
...
function Close-SmartThinClientGuiSplash {
    [CmdletBinding()]
    param([AllowNull()]$Splash)
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCTjHIsSpu0e0BS
# XQ476I51qqFq2d1zDRQuOLS4ipLa/6CCF/swggS9MIIDJaADAgECAhAebu87xzjh
...
# hvcNAQkEMSIEIJ/6bbpo59M8S09B2STW1hW1BnyKNICDOp45tYerqRQBMA0GCSqG
# SIb3DQEBAQUABIIBgHjt6q3qj01SOypOt4/ojesKLgQ83gKzRG9xXmkGROjwe+Es
# DoV22P4AlZR4nAI7VEuXkep/Zhu+/+A8DbtbX5lChbyolXohkW85q/ad8Bg4VIi9
# ER0A1JnG6F+584ZfCvzCPJkmUA8y+lYKxb0jQcpOLegkca2mquSd7AnLfHS92DwM
# FWgTXTFQQb4x2AEBrZ1dBx/ua9JW5aat5mG7/lsFlZA2eQXmnD1NYyoLi1XFK0kW
# JQttr33JiM++UkM5ncW/QopFboMOncssoiVfH2IbUiZXPfJgVo5FJwqp2BH2KdjO
# d4iLnPjyeAVMGTQ7TjEho+N7NGxsWezJgTfdN/hPBBE9u4Qm9NtpnrK/ov3H9jBJ
# Uol8JjvKctqZvFUt+SX5RCEdJkvwCzuI6+u9+fQ2xVIPwUjGJ3UAbn0T0PIUVpA+
# RKv/En29eZYrUXf14PElbr6faz2Nl75u6XbVfNSlbDJLymynBmjPWZTnvIojPser
# 8imXgTqou4fNX2Z4sKGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkx
# CzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4
# RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYg
# MjAyNSBDQTECEAqA7xhLjfEFgtHEdqeVdGgwDQYJYIZIAWUDBAIBBQCgaTAYBgkq
# hkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjA3MTMwODUw
# NDBaMC8GCSqGSIb3DQEJBDEiBCAkiTLQOkePf+hUBATZK5InjIf1sUCIDqo0aRPH
# huxUvTANBgkqhkiG9w0BAQEFAASCAgDPsHF1k4PZlTk2XWN2WNGIid4MTOHf2IGl
# RgubkX9lw/8LGeUJgYb6qc7kj/MNcFgyzJgxGucgy9z9gJuDdv2CcaOzLfPdFYhn
# caX5MNNzWqpSv380OK+38qF9l7Ce5zBHVm/F3OQuVBJyc7FbWUc2PYCy6qxiwDM0
# rNEtEFVv055sDeVwpr2fq2wOj7V1TLzJDapWuvVkitrkKaG+AiRDshYmRSrPD17C
# L11peVKwwoYdSmzzOcT1PyMSr/B6uUCF8kXpBUJF4EtIithVWQcrFKJOrnCcEQMI
# mT8yzSMPsd7TWtdnTdi2WJTgPbwEtJto9zaXwYt5CxOg8ZOq2kOyuFJYJY3Ow8bZ
# aeDkjzTXKOPvFjOeSi+FhyWRZ+NDWRCI/hJ6vtrJXGR0d3H+oCi4Bfm8q4kM4NhJ
# Jq7S9lxK+GA/HcvH5iY0hie6rbkVVK+qP+5PiApBrNjIZLiBUm1eQLfkcKAa1bS8
# s54y+FHatSwFkGfXYPbrDaPjz13kBtwej0+O/mA5VMAyA+njMh7BXTJU2z6SZYaG
# Jt5fIWbjq/PwyBQujYIAJ2qtlWHDf5YNPdj+1eSzBtywZMRH1YSp8/7/nwzr3zKH
# Ce3QnHsKt0LkBqnEgWQNK7LxENevziqFg5ytgVXWUuBHBdJcxnr6T8HcLuYaEACj
# 2yRNon2qUw==
