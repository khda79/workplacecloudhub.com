...
.DESCRIPTION
    Exposes two public functions:
        ...
        Resolve-SmartAzureSpDriveId
            ...
            Cache the result and pass it to Invoke-SmartAzureSpFileUpload to avoid
    ...
    USAGE EXAMPLE
        Import-Module ".\Modules\SmartAzure.SharePoint\SmartAzure.SharePoint.psd1" -ErrorAction Stop

        $spDriveId = Resolve-SmartAzureSpDriveId `
            -Headers             $headers `
        ...
        $spResult = Invoke-SmartAzureSpFileUpload `
            -Headers           $headers `
            -LocalFilePath     $CsvFinal `
            -TargetFolderPath  "SmartAzure-DATA/CSV" `
            -DriveId           $spDriveId `
            -Logger            { param($m,$l,$s) Write-Log $m $l $s }
...
# ==========================================================
# Public: Resolve-SmartAzureSpDriveId
# ==========================================================
function Resolve-SmartAzureSpDriveId {
    <#
    .SYNOPSIS
...
# ==========================================================
# Public: Invoke-SmartAzureSpFileUpload
# ==========================================================
function Invoke-SmartAzureSpFileUpload {
    <#
    .SYNOPSIS
        Uploads a single local file to a SharePoint Online document library.
    .DESCRIPTION
    ...
    .PARAMETER TargetFolderPath
        Relative path of the target folder inside the drive root, e.g. "SmartAzure-DATA/CSV"
    .PARAMETER DriveId
    ...
    try {
        ...
        if ([string]::IsNullOrWhiteSpace($DriveId)) {
            ...
            $DriveId        = Resolve-SmartAzureSpDriveId -Headers $Headers -SiteHostname $SiteHostname -SitePath $SitePath -LibraryDisplayName $LibraryDisplayName -Logger $Logger
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDWP6Ih9t+Py0Is
# S0V2rgvMd1pbLsbC+Togunj6kWkshqCCF/swggS9MIIDJaADAgECAhAebu87xzjh
...
# hvcNAQkEMSIEIEoOd2gBGgfpbyXfTCHVV6i+3Egsj1YTa+T0ClehLmpSMA0GCSqG
# SIb3DQEBAQUABIIBgD1lUkexRDLC6wH0KQd0tjPhgfRTZS27oQQLUUqAtppmz2eF
# f2yIs+DlFGeS0GI3TV8kY56fRfRjihaWk5S9++sqfTQP6QECJGu896FhsQMVjrs7
# TjB4vN8NOuLd9WgfuL5bSXOB3xkoGlMz5JuGZLi9NniXYrOC1kCdvqfqZCxTqWV8
# btd61mO4NRFaPOoHXjU2x+XUe4ATwmK81PB5DLDzAU9P8Dotd5mXdjOTLbfAUvEi
# 5aZ0VILxt3b8eWbj7QlnGLr4ygNGhALAIBe3JKBsp3Y+dqm5ikDF4q/lq1HSaDER
# EW6Fbh9MDlXPTWfMgELiUZJ+MGeilVPjaVO2FCJd1zdWlHozQzGAeXB12ZJ50d1b
# Wm8p8qMP3vV7bnjzr4Wmp7LKuDZOhlH1jqMkWXYbaA08gfV1or4fQAosXfSs5Xpv
# rPFnbI4LvpfGV5ntmeOjs+3z1V8GmXfElbpbMlmaLtjDX3nstHjdDs828cXHa/lt
# 8jVeuMm05B5im53+NqGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkx
# CzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4
# RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYg
# MjAyNSBDQTECEAqA7xhLjfEFgtHEdqeVdGgwDQYJYIZIAWUDBAIBBQCgaTAYBgkq
# hkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjA3MTMwODQ5
# MDhaMC8GCSqGSIb3DQEJBDEiBCCB4tQDWFg44MlRCybrOoVuudqsaVIYgKOd1jI0
# 17itljANBgkqhkiG9w0BAQEFAASCAgAl4RJru/P2VIJqjzPp/gb8PwtAlsWJKsqn
# nk38aWRWPsULTwV9cU73I79udmDTPtBDN6hRxi6RXa0M23o4/8uxEfiNhJgJBFTC
# 5su9kIWnzGKXmcCYWtBsElCjdL1K4DCYo6E8XTBylbuzDpnnmRYxqRej68n9+V2t
# 8BV1dyoK8NRV2Kh4/Z1iClSwXdTJddI9wX6YD3ilT/1/oeRZd7olXYYDjiydwBzS
# l/hVQf9rbte/NcarEahWF0xHJcBM1fZWjPAfq1NJy0aCoMzsMUU04r53cDQnHTjH
# 1tkRppS10Qxwao8TeTYBJ7AkiMCUYo5yfobMbKBgzXBA7bf/L4b9q+xpHCwrNmNk
# 5OtP3Oe6GTnZB0DG0GGsga3LS3yNasZ6nFn/HC5XUfCojJNltMQhWbBAdQuWlTEs
# adXw/U0fCDoaayFjJuAiMe5D/lr+rTarRBunk4YJeG/SpWlPn9+1ew2dEMtmIuo8
# XaQ6w7827eQMEfRUluOFdBBsPusiCmoNDqWhbcaa2D9MfLv1ETkZqf2Y9lWtY/aD
# KsBdkm/iHrXe4QxUQy09SHMgT5gXZIiH7KMY3eYwqLW3N6s4fzQSrrDOyP7TU/O/
# X7weL4Paf/M8bhVBlBTMrDl1YyCgI/8qeyc0Y4qJqiJXuDOOWRslRMYvBzDj900a
# Xl5XWU1u5g==
