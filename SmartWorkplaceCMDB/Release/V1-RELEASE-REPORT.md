...
6. **Collectors included:** AD domains/users/groups/computers/direct memberships; Entra users/groups/devices; Intune managed devices/hardware; Microsoft 365 SKUs/assignments; Exchange Online mailboxes.
7. **Collection extensions added for V1:** Intune encryption and list-only hardware; bounded shared Graph retry handling.
