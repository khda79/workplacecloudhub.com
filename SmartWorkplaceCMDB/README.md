...
```powershell
pwsh -NoProfile -ExecutionPolicy Bypass -File .\SmartWorkplaceCMDB\Build\SmartWorkplaceCMDB-Build.ps1 -Tenant prod -OrganizationKey Contoso -EnvironmentKey prod -TenantKey Contoso-prod
```
