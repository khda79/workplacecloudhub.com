...
try {
    ...
    Invoke-SmartWorkplaceCMDBIntuneDeviceTest 'Enrich Entra devices and retain Intune-only devices' {
        ...
        Assert-SmartWorkplaceCMDBIntuneDeviceTrue (
            ...
            $matched[0].EncryptionState -eq 'Encrypted' -and
            $matched[0].PrimaryUserId -eq '11111111-1111-1111-1111-111111111111'
        ) 'Matched Intune enrichment is invalid.'
    }

    Invoke-SmartWorkplaceCMDBIntuneDeviceTest 'Preserve encrypted, not encrypted and unknown states' {
        $cmdb = @(Import-Csv $script:Normalization.CmdbDeviceOutputPath)
        Assert-SmartWorkplaceCMDBIntuneDeviceTrue (
            @($cmdb | Where-Object EncryptionState -eq 'Encrypted').Count -eq 1 -and
            @($cmdb | Where-Object EncryptionState -eq 'NotEncrypted').Count -eq 1 -and
            @($cmdb | Where-Object EncryptionState -eq 'Unknown').Count -eq 2
        ) 'Encryption states were not mapped without conflating missing and false.'
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAYFxgkZKEhtlTF
# vRFI3iIqumvpFoTvzXLtnr7wT1NvI6CCF/swggS9MIIDJaADAgECAhAebu87xzjh
...
# hvcNAQkEMSIEIHWyOmQV8AiZlwcVVBnNPyfNVTGEs5QJM4JsSprZdKJ3MA0GCSqG
# SIb3DQEBAQUABIIBgEgPADsgjMteytuCkxl2p3v/dqKZOE/N2AQtXAAejoeC37bf
# JYC/1qzWvqvbtZ3ZMdexWTirT8gYyyp/ql4Yx5XSxBvSj8goCGCgq2T9UV2npV1x
# 2BK8S2zT796k6e0F7OZjSiQ3GXminTgvnN4EkN6OPWPHlsehpVPlvfmxC77g3Xpq
# YqchPKXujvhl7vZdgvwYk195mGQ1zbny+0N8GLPmNwyOJpho8yI72xzwFelGtO35
# ILtT08s6VpShrFzLCRVTuhmAkta5/4gKucnEngktnuyjhzYXEUJqrBKBYoi7fhBy
# BF11N8pberR9T+yThMSmx1jGUgIwpN7F7MeDGoQafmPsErYbOLg2VqfePndUclFS
# hteDcLsceXiHTUZbwicy9Ueb0trk0Y/GEoQStlUE529/F/N14vibDPAHItp93NPQ
# /RteC5KqCso9aZ6U9pO7ATrkqSukj1DtnVlQ7mV7j5Dd1l19nd0kT+OTmOOp4S6c
# g5lWfdlXAFIsDD9V/KGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkx
# CzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4
# RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYg
# MjAyNSBDQTECEAhP3DNPfkVO28MPj/mSGDUwDQYJYIZIAWUDBAIBBQCgaTAYBgkq
# hkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjA5MTExNTE1
# MTlaMC8GCSqGSIb3DQEJBDEiBCCnZ7z2vMCtt4MPNm6TqsqQgH9qJljOhSQFeVKU
# kh1PEDANBgkqhkiG9w0BAQEFAASCAgAo2VyZ1IF7UHGOGtmua6nNkt3CkIM3Gcem
# QGaerTCSsZe7IVx5G4esaLUdpOjijnS6eopB0BLL3XB0npzWiijshodt6gB55sJf
# PyGmcVq7mAfDOrpvdyXBeNdztBjnp8GL1BD7mJUnU0gsxCKS90hbpI92yUnw+09U
# eYfrX7U/k4n07ypKgMZEprAVZuc4lKw09sgtnv7wHMJD7GJ2mrNyxgse1bYO8g6i
# 4Fz3gP2Eswz0CuQYDrAj9m8tvOgUZnHt1M07JO7j5vAljVDGZpbfhBg2O9BTqjql
# S68szm1My/gwIfIFdfnbGmeJOfLaK5LkbDZeQYTl9R1nWZKA75PsGXO93KaEZiuU
# k+it5CHODwBKryg38HfLh7nc42zMVq/tOtkeJTsevisdkMdkvWLhcZ1A35cE5zqE
# yThu7hTZzWMY6Q4mHAJRphEW0urwWJIYGC/TZL/J7rSm4B11XA5O50RLVtnsb3kN
# SCfVsxSrYT8Ns9tNfhiatbsLQ1Ay9mdc6SZ7kr3UOt8gKlhv29GGlDBN5MXzTOk5
# zCDozWoP8CXqHyFIS/z+2hzbx0Vjm5q8648ia/MFHShVOn5mRBUtuSFKAF3D8++3
# k5x6hd7B5KeuwP81S9YpHJuGbCn3ZRMJjsCPY0GOrJ73t2bLuhLXiWdJ4KGNqgLM
# d88YjDHwFQ==
