...
function Select-SmartWorkplaceCMDBOldestDateText {
    [CmdletBinding()]
    param(
...
if ($ValidateOnly) {
    if (Test-Path -LiteralPath $EntraRawInputPath) { Import-SmartWorkplaceCMDBSourceCsv -LiteralPath $EntraRawInputPath -Paths $paths | Out-Null }
    if (Test-Path -LiteralPath $IntuneRawInputPath) { Import-SmartWorkplaceCMDBSourceCsv -LiteralPath $IntuneRawInputPath -Paths $paths | Out-Null }
}
...
$entraRows = @(Import-SmartWorkplaceCMDBSourceCsv -LiteralPath $EntraRawInputPath -Paths $paths -ErrorAction Stop)
$intuneRows = @(Import-SmartWorkplaceCMDBSourceCsv -LiteralPath $IntuneRawInputPath -Paths $paths -ErrorAction Stop)
...
foreach ($entra in @($entraRows | Sort-Object DeviceName, SourceDeviceId)) {
    ...
    $outputRows.Add([pscustomobject][ordered]@{
        ...
        SourceCollectedDateTime = if ($null -ne $intune) {
            Select-SmartWorkplaceCMDBOldestDateText ([string]$entra.SourceCollectedDateTime) ([string]$intune.SourceCollectedDateTime) $sourceDeviceId
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB3hyWgw542MmTI
# LYTdhhenULS26lc/uVYwZuA5aNutSaCCF/swggS9MIIDJaADAgECAhAebu87xzjh
...
# hvcNAQkEMSIEIMMGwJlVPcscoLtZUVduTYf1/e7fBV6sZ4lxq1QIphVSMA0GCSqG
# SIb3DQEBAQUABIIBgBK1u0Swo0MbiAvcdlWwXjXppOTioGu+2RqhwMI63JPHlW8P
# V8c+KeVh/OwBZBGjdcy2661Pq/XuxyXgtr+FaYn3cQW22ymt1pTwqw3PNa+RWk2K
# AjCu2PvWy7F+gDKoIAs9CztPWknBuAghH58djtfSmN6qOKWZZgTyupOnKmA8PiDM
# C5OAPWrSkxhjSlSZVRSDOKimL7VfQbDJ0MLgf8PooMHups0zUIYDaXjFqsjCnx1P
# MOfISB3+Hwu8lx2F8hEfZZO0F6sg+unoJ3xVoXuMdapKzxRrYztvWZv9IVK7g/AD
# B8d9tOfUbYS8Bk/rn7XuH6OYAjbCIUWu5zGvLp9GxNo3qeWvVKp3BxosCJ425a+b
# f4HAFWzeKk7ZFtzxL7AFl2GOM1T1rTFOSn1BZjpMPutIN0E41PibJXMuiy115LA2
# b7bekvS+NF0zkYrqzTA/4ZfhoL6jT+8+1ip1ET2ifBAus0hqKYrLUZ+yy4RXUhb1
# AK9azW3MpO1TWEJ5PqGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkx
# CzAJBgNVBAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4
# RGlnaUNlcnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYg
# MjAyNSBDQTECEAhP3DNPfkVO28MPj/mSGDUwDQYJYIZIAWUDBAIBBQCgaTAYBgkq
# hkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjA5MTIxMzI1
# MjBaMC8GCSqGSIb3DQEJBDEiBCDvQJ/SRo1EeQQhkS7nhZ+/6EZmg0NfQTRvEBXd
# j84A+zANBgkqhkiG9w0BAQEFAASCAgCV6XbcTyxDrAtZFdVsrdaC0yllA5VUJ+xa
# wdKu9cXXC/Tl2jTx1V8sG63gffZV2uzuUtNCCIl4x8RbilsW8QxiLWnegT0+eMjP
# 6N1SeDFnHpkhnPbx/CzM45+ZFhmP4raMMZTE0zH2pSEGLILNOMzD6BppYH5BG2fy
# FvsCOZ9phhC2rqC+qtq1TGqxdxxAuneExAYMQgQpSbzlKTREYNR2f97KtXFDUMxM
# 4gBSK46eKeQPALkRC65onihBy5xxjTWuvrzm42J7N2pHRdl3w7XQSNvoc0deBpct
# EoZPWKr2P1DSoW6TO++p4yta8jP7Qf8UPxpYWgrT/pu6HbHWbOIEida238CmeKLg
# 6ArUOncP+zN0sjHMZrkzUqvk/3lsiezxUldQFVCjJgzuPLGImwomYyJ93LGPwLLt
# QypVr/k1HB/9IJwBAKygt53q2Lp4TeXSpFWMMFWnBWkp/7s9pfQJTKU8+JJIO0CN
# tuGZ6J6nsu0h3b4Onsjqj10nQAE7sgDMJQmrSDHGDzUBsQgsaER8A73Rm73CPJOs
# tijGORYdBKak1FOx8CeSnJmJQMybj1Ia9MihRd+B8l4Ps+zkQJp7oo5V18nqg2Im
# A73HPOOIbSMSJg/6M1CYcWRD4COcTvmS+589wxu+lAoTt37oMaZHtLYgm0tvJL+G
# N3kNQ5QaaQ==
