...
def build(root, output, include_360=False):
    ...
    write_json(output / "CMDB-REPORTS.pbip", {"$schema": BASE + "fabric/pbip/pbipProperties/1.0.0/schema.json", "version": "1.0", "artifacts": [{"report": {"path": report_dir.name}}], "settings": {"enableAutoRecovery": True}})
